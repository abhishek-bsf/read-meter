...
if (! class_exists('BSFRT_Loader') ) :
    ...
    class BSFRT_Loader 
    {
        ...
        public function bsf_rt_process_form_general_settings()
        {
            ...
            include_once BSF_RT_ABSPATH . 'includes/bsf-rt-page.php';
            ...
            if (isset($_POST['bsf-rt-general']) && wp_verify_nonce($_POST['bsf-rt-general'], 'bsf-rt-nonce-general') ) {
                ...
                // if (! empty( $_POST['bsf_rt_words_per_minute'] )) {
                //     $bsf_rt_words_per_minute= intval( $_POST['bsf_rt_words_per_minute'] );
